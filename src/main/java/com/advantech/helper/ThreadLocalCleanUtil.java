...
之前為了解決專案重啟會出現的log訊息
created a ThreadLocal with key of type XXOO but failed to remove it when the web application was stopped. 
                ...
                for (int j = 0; j < table.length; ++j) {
                    if (table[j] != null) {
                        ...
                        if ((key != null)
                            ...
                            logger.info("clean threadLocal key,class="
                        ...
                        if ((value != null)
                            ...
                            remove = true;
                            logger.info("clean threadLocal value,class="
